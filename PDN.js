document.addEventListener("DOMContentLoaded", () => {
  ...
  const products = [
    {
      img: "images/kurta-offwhite.jpg",
      alt: "Kurta Offwhite",
      name: "Kurta Offwhite",
      rating: 5,
      price: 189,
      discount: { original: 240, percentage: "-20%" },
    },
    {
      img: "images/melati-blushpink.jpg",
      alt: "Melati Blushpink",
      name: "Melati Blushpink",
      rating: 4,
      price: 189,
      discount: null,
    },
    {
      img: "images/liana-platinumblue.jpg",
      alt: "Liana Platinumblue",
      name: "Liana Platinum...",
      rating: 5,
      price: 189,
      discount: { original: 210, percentage: "-10%" },
    },
  ];
      ...
      const productHTML = `
              <div class="product">
                  ...
                  <div class="price">
                      ...
                      ${
                        product.discount
                          ? `<span class="discount">RM${product.discount.original} ${product.discount.percentage}</span>`
                          : ""
                      }
                  </div>
              </div>
          `;
      productContainer.innerHTML += productHTML; // Append product HTML
    });
  }
